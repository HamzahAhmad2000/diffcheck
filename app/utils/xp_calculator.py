...
XP Sources on the Platform:
1. Survey Completion: Dynamic XP based on question count (default 5 XP/question)
2. Quest Completion: Predefined XP in quest configuration
3. Daily Rewards: Configurable XP or raffle entries (see DailyRewardController)
4. Week Completion Bonus: Extra XP/rewards for 7-day streaks
5. Profile Activities: Fixed XP for profile completion sections
6. Feedback: Bug reports (10 XP), Feature requests (5 XP)

Daily Rewards Integration:
- Daily login rewards can award XP or raffle entries
- Rewards are configured per day of week by admin
- XP from daily rewards is logged separately via award_xp_no_commit()
- Recovery system allows spending XP to claim missed days
- Week completion bonuses provide additional XP incentives

See DailyRewardController for detailed daily reward XP calculations.
"""
