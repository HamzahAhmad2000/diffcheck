...
def create_app():
    ...
    # Register Stripe webhook and checkout routes
    from app.routes.stripe_webhook_routes import stripe_webhook_bp
    from app.routes.stripe_checkout_routes import stripe_checkout_bp
    app.register_blueprint(stripe_webhook_bp, url_prefix='/api/stripe')
    app.register_blueprint(stripe_checkout_bp, url_prefix='/api/stripe')
